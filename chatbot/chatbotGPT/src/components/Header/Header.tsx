  ...
  return (
    ...
    <Container>
      ...
      <Navbar.Collapse className="justify-content-end" id="responsive-navbar-nav" >
        <Nav>
          <Link spy={true} smooth={true} duration={500} activeClass="active-link" to='about' offset={+5} style={{padding:'0.5rem', border: '1px solid rgba(205, 205, 205, 0.5)',borderRadius: '30px',margin:'5px', color:'rgba(205, 205, 205, 0.5)'}}><User color='rgba(205, 205, 205, 0.5)' style={{padding:"2px"}}/>About Me</Link>
